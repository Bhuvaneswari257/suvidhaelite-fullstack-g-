...
export default function SupportInquiries() {
  ...
  // Filter inquiry tickets
  const inquiryTickets = tickets.filter(t => t.type === "inquiry");
  ...
  return (
    <div className="space-y-6">
      ...
      {inquiryTickets.length === 0 ? (
        <div className="bg-white p-6 rounded-lg shadow">
          <p className="text-gray-500 text-center">No inquiry tickets at this time.</p>
        </div>
      ) : (
        <div className="space-y-4">
          {inquiryTickets.map((ticket) => (
