...
export default function SupportBookingIssues() {
  ...
  // Filter booking tickets
  const bookingTickets = tickets.filter(t => t.type === "booking");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Handle cancellations, scheduling conflicts, and booking-related problems.
        </p>
      </div>

      {bookingTickets.length === 0 ? (
        <div className="bg-white p-6 rounded-lg shadow">
          <p className="text-gray-500 text-center">No booking issue tickets at this time.</p>
        </div>
      ) : (
