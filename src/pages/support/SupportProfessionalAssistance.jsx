...
export default function SupportProfessionalAssistance() {
  ...
  // Filter professional assistance tickets
  const professionalTickets = tickets.filter(t => t.type === "professional");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Help service providers resolve platform issues and account problems.
        </p>
      </div>

      {professionalTickets.length === 0 ? (
        <div className="bg-white p-6 rounded-lg shadow">
          <p className="text-gray-500 text-center">No professional assistance tickets at this time.</p>
        </div>
      ) : (
                  ...
                  {selectedTicket === ticket.id ? (
                    <div className="space-y-3">
                      <textarea
                        ...
                        placeholder="Enter assistance details..."
